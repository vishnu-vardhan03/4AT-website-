                  ...
                  {backgrounds.map((option) => {
                    ...
                    return (
                      <button
                        ...
                        className={`relative px-5 sm:px-6 py-3 rounded-full text-[11px] sm:text-xs font-bold uppercase tracking-wider transition-all duration-300 cursor-pointer ${isSelected
                  ...
                  {interests.map((chip) => {
                    ...
                    return (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        className={`inline-flex items-center gap-1.5 px-5 py-2.5 rounded-full text-[11px] sm:text-xs font-bold uppercase tracking-wider cursor-pointer transition-all duration-300 ${isSelected
                            ? "fx-primary-btn text-white shadow-[0_0_18px_rgba(45,212,191,0.25)]"
                            : "fx-ghost-btn text-slate-300 hover:text-white"
                          }`}
                      >
