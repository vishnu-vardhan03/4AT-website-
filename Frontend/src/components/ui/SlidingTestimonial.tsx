        ...
        <div className="w-full lg:w-[42%] flex justify-center lg:justify-end relative z-10">
          {hasTestimonials ? (
              ...
              <div className="flex gap-5 overflow-x-auto py-4">
                {testimonials.map((testimonial, indx) => (
                  <div
                    ...
                    className="border border-blue-500/20 flex flex-col bg-gradient-to-b from-[#101726] via-[#0b0f19] to-[#080b12] rounded-2xl shrink-0 w-[min(300px,calc(100vw-2.5rem))] sm:w-[480px] md:w-[580px] justify-between overflow-hidden shadow-[0_8px_24px_rgba(0,0,0,0.5)]"
                  >
            ...
            <motion.div
              ...
              className="relative w-full max-w-[500px] border border-blue-500/20 bg-gradient-to-b from-[#101726] via-[#0b0f19] to-[#080b12] backdrop-blur-xl rounded-2xl p-6 sm:p-8 text-center shadow-[0_8px_24px_rgba(0,0,0,0.5)] overflow-hidden group hover:border-blue-400/50 transition-all duration-300"
            >
              {/* Ambient glows inside card */}
              <div className="absolute -top-20 -left-20 w-44 h-44 bg-teal-500/10 rounded-full blur-2xl pointer-events-none" />
              <div className="absolute -bottom-20 -right-20 w-44 h-44 bg-sky-500/10 rounded-full blur-2xl pointer-events-none" />

              {/* Static Icon */}
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-teal-500/10 border border-teal-400/30 text-teal-300 mb-4 shadow-sm">
