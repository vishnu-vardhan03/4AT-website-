    ...
    <header className="fixed left-1/2 top-3 z-50 w-[min(1500px,calc(100%-1.5rem))] -translate-x-1/2 rounded-2xl border border-white/10 bg-[#05081c]/95 shadow-[0_16px_45px_rgba(0,0,0,.38)] backdrop-blur-xl">
      <div className="flex min-h-16 items-center gap-4 px-3 md:px-4">
        ...
        <div className="ml-auto flex items-center gap-1.5">
          ...
          <a href="/essl/cab" target="_blank" rel="noopener noreferrer" className="inline-flex h-10 items-center gap-2 rounded-lg border border-emerald-400/30 bg-emerald-400/10 px-3 text-sm font-bold text-emerald-300 hover:bg-emerald-400/20" aria-label="Open CAB operations in a new tab"><CarFront className="size-4" /><span className="hidden sm:inline">CAB</span><ExternalLink className="size-3" /></a>
